...
function JournalForm(props) {
	...
	return (
		...
		<div className="flex-field">
			...
			<LabelElement labelFor={'journal'} text={textUsed.labels.journal} />
		</div>
		<div className="flex-field">
		...
		<div className="flex-field-half-wrapper MT32">
			...
			<div className="flex-field half">
				...
				<LabelElement labelFor={'issue'} text={textUsed.labels.issue} />
			</div>
		</div>
		<div className="flex-field">
			<input id="doi" className="field" type="text" data-validations="doi" data-search-category="payload" />
			<LabelElement labelFor={'doi'} text={textUsed.labels.doi} />
		</div>
		</section>
	);
}
