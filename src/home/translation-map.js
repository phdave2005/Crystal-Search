export const TEXT_MAP = {
    ...
    en: {
        ...
        heading: {
            ...
            filters: 'Filters',
            cifSearch: 'Directly Retrieve .cif Data'
        },
        menu: {
        ...
        validation: {
            ...
            labels: {
                ...
                idSet: 'Invalid format for set of COD IDs',
    ...
    es: {
        ...
        heading: {
            ...
            filters: 'Filtros',
            cifSearch: 'Recuperar directamente datos .cif'
        },
        menu: {
        ...
        validation: {
            ...
            labels: {
                ...
                cif: 'Necesita un identificador .cif válido',
                ...
                idSet: 'Formato no válido para el conjunto de identificadores de bacalao',
    ...
    fr: {
        ...
        heading: {
            ...
            filters: 'Filtres',
            cifSearch: 'Récupérer directement les données .cif'
        },
        menu: {
        ...
        validation: {
            ...
            labels: {
                ...
                cif: 'Besoin d\'un identifiant .cif valide',
                ...
                idSet: 'Format non valie pour l\'ensemble des identifiants de code',
    ...
    it: {
        ...
        heading: {
            ...
            filters: 'Filtri',
            cifSearch: 'Recupera direttamente i dati .cif'
        },
        menu: {
        ...
        validation: {
            ...
            labels: {
                ...
                cif: 'È necessario un identificatore .cif valido',
                ...
                idSet: 'Formato non valido per il set di ID COD',
